!function (a) {
    a.fn.animatedHeadline = function (e) {
        function n(e) {
            e.each(function () {
                var e = a(this), n = e.text().split(""), s = e.hasClass("is-visible");
        ...
        function s(a) {
            ...
            } else a.parents(".ah-headline").hasClass("clip") ? a.parents(".ah-words-wrapper").animate({width: "2px"}, h.revealDuration, function () {
                d(a, i), t(i)
        ...
        function t(a, i) {
            a.parents(".ah-headline").hasClass("type") ? (o(a.find("i").eq(0), a, !1, i), a.addClass("is-visible").removeClass("is-hidden")) : a.parents(".ah-headline").hasClass("clip") && a.parents(".ah-words-wrapper").animate({width: a.width() + 10}, h.revealDuration, function () {
                setTimeout(function () {
                    s(a)
        ...
        this.each(function () {
            ...
            if (h.animationType && ("type" == h.animationType || "rotate-2" == h.animationType || "rotate-3" == h.animationType || "scale" == h.animationType ? i.find(".ah-headline").addClass("letters " + h.animationType) : "clip" == h.animationType ? i.find(".ah-headline").addClass(h.animationType + " is-full-width") : i.find(".ah-headline").addClass(h.animationType)), n(a(".ah-headline.letters").find("b")), i.hasClass("loading-bar")) p = h.barAnimationDelay, setTimeout(function () {
                ...
                var e = i.find(".ah-words-wrapper"), t = e.width() + 10;
                e.css("width", t)
            } else if (!i.find(".ah-headline").hasClass("type")) {
                var l = i.find(".ah-words-wrapper b"), o = 0;
                l.each(function () {
                    var i = a(this).width();
                    i > o && (o = i)
